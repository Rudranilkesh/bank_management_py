...
class Bank:
    ...
    def deposite_money(self):
        accoutnum = input("please tell your account number:-")
        pin = int(input("please tell your pin aswell:- "))

        userdata = [i for i in Bank.data if i['accountNo'] == accoutnum and i['pin'] == pin]
    ...
    def update_details(self):
        ...
        if userdata == False:
            ...
            newdata = {
                ...
                "pin": input("enter your new pin or press to skip: ")
            }
    ...
    def delete(self):
        ...
        if userdata == False:
            print("sorry not such data exist")
        else:
